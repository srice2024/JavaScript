...
if (age >= 18) {
    ...
    console.log(`You have to wait ${yearsLeft} before you can take your driver's test.`)
};
...
const newAge = 11;
const drink = newAge >= 18 ? console.log('I like to drink wine') : console.log('I like to drink water')
...
console.log(`At my age ${newAge >= 18 ? 'I like to drink wine' : 'I like to drink water'}`)
